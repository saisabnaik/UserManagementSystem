        ...
        <div class="jumbotron">
        	<form class="form-horizontal"  action="${pageContext.request.contextPath }/handle-emp" method="post" >
                    ...
                    <div class="form-group">
                       ...
                       <div class="col-sm-10">     
                       <label class="radio-inline"><input type="radio" name="gender" value="${emps.gender}" >Male</label>
                       <label class="radio-inline"><input type="radio" name="gender" value="${emps.gender}">Female</label>
                       <label class="radio-inline"><input type="radio" name="gender" value="${emps.gender}">Other</label>
                       </div>
                    </div>
                     <div class="form-group">
