...
<body>
 <div class="container-fluid mt-3">
       <h1 class="text-center mb-3" class="text-success">Welcome update</h1>
			<nav class="navbar navbar-expand-sm bg-primary navbar-dark">
			  <ul class="navbar-nav">
			    ...
			    <li class="nav-item">
			      <a class="nav-link active" href="update_view">Update</a>
			    </li>
			    <li class="nav-item">
					...
					<table class="table table-striped table-dark">
						  ...
						  <c:forEach items="${emps}" var="p">
						    <tr>
						      ...
						      <td>${p.gender}</td>
						      <td>${p.salary}</td>
						      <td><a href="update/${p.id}"><i class="fas fa-pen-nib text-primary" style="font-size:20px;"></i></a>
						      </td>
