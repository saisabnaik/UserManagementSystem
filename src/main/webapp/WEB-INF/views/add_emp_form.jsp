...
<body>
	<div class="container-fluid mt-3">
		...
		<ul class="navbar-nav">
			<li class="nav-item "><a class="nav-link" href="index">View</a>
			</li>
			<li class="nav-item"><a class="nav-link active" href="add_emp">Insert</a>
			</li>
			<li class="nav-item"><a class="nav-link " href="update_view">Update</a>
			</li>
			<li class="nav-item"><a class="nav-link" href="delete_emp">Delete</a>
			</li>
			<li>
		...
		<div class="panel panel-default">
			...
			<div class="jumbotron">
				<form class="form-horizontal" action="handle-emp" method="post">
					...
					<div class="form-group">
						<label class="control-label col-sm-2" for="phno">Mobile
							No:</label>
						<div class="col-sm-10">
							<input type="text" class="form-control" id="phno"
								placeholder="Enter Mobile Number" name="phno">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<label class="radio-inline"><input type="radio"
								...
								value="FEMALE">Female</label> <label class="radio-inline"><input
					...
					<div class="form-group">
						<label class="control-label col-sm-2" for="salary">Date of
							Birth:</label>
						<div class="col-sm-10">
